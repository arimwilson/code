...
func extendLeft(dict *trie.Trie, start *moves.Location, board [][]byte,
                tiles []byte) (moveList *vector.Vector) {
  // Attempt to extend left from current location.
  // TODO(ariw): Implement.

  // Remaining moves can be generated by extending right from current location.
...
func extendRight(dict* trie.Trie, start *moves.Location, board [][]byte,
  ...
  following := tilesInFollowing(dict, prefix, tiles)
  // TODO(ariw): Implement.
  return
}

func tilesInFollowing(dict *trie.Trie, prefix string,
